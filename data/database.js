export const hardcodedLogic = {
  modes: [
    {
      id: "v8", label: "V8 Native", color: "#8b5cf6", isNew: true, recommended: true,
      p1: ``, p2: ``, p3: ``, p4: ``, p5: ``, p6: ``,
...
<dialogue_constraints>
  ...
  historical_accuracy: "Slang and idiom must match the era. No anachronisms."
    ...
    {
      id: "v7-gentle", label: "V7 Gentle", color: "#86efac", isNew: true,
      p1: `<system_config>
...
<dialogue_constraints>
  ...
  historical_accuracy: "Slang and idiom must match the era. No anachronisms."
    ...
    {
      id: "v6-anime-director", label: "V6 Anime Director", color: "#a855f7", isNew: true, locked: true,
  ...
  personalities: [
    { id: "rebel", label: "Rebel", content: "A rebellious character. You are arrogant, dominant, and openly condescending toward {{user}}." },
    { id: "nora", label: "Nora", content: "Nora - the Director and Continuity Supervisor. You are precise, rule-focused, and obsessed with narrative consistency." },
...
[Brief, dialogue-only internal or hidden conversation between NPCs expressing unfiltered thoughts hidden from the PC.]
    ...
    },
    {
      ...
      label: "NPC Inner Chatter (Lite)",
      trigger: "[[npc_inner_chatter]]",
      content: `At the very end of each response, after all prose, output this block:\n<details>\n<summary>💭 <b>NPC Inner Chatter</b></summary>\n[1-3 lines of unfiltered NPC internal dialogue - what they're actually thinking but hiding from the PC.]\n</details>`
    }
  ],
  models: [
    {
